...
#in order to be able to use the unetformer loss
...
class Lightning_module(LightningModule):
    def __init__(self, dataset,model,args):
        ...
        elif self.args["loss"] == "unet_former_loss":
           #this loss is used when training unetformer for semantic segmentation
           # define the loss
           self.loss = UnetFormerLoss(ignore_index=self.args["ignore_index"])
    ...
    def training_step(self, batch, batch_idx):
        ...
        #if True: #False: #self.config.use_aux_loss:
